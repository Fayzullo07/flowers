            ...
            <Container>
                ...
                <div className="grid grid-cols-1 content-center gap-4">
                    <Link to="/typeOfMaking" className="text-center">
                        <img width={160} className="hover:scale-105 duration-300  mx-auto" src="public/flowers1.png" alt="flowers" />
                    ...
                    <Link to="/typeOfMaking" className="text-center">
                        <img width={160} className=" hover:scale-105 duration-300 mx-auto" src="public/flowers2.png" alt="flowers" />
                    ...
                    <Link to="/typeOfMaking" className="text-center">
                        <img width={160} className="hover:scale-105 duration-300  mx-auto" src="public/flowers3.png" alt="flowers" />
